from vhh_formula import WHH4b_LO, ZHH4b_LO
from heptools.physics import XSection, Decay

Decay.add('H->bb', 0.5824) # mH = 125 https://twiki.cern.ch/twiki/bin/view/LHCPhysics/CERNYellowReportPageBR
Decay.add('Z->bb', 0.1512) # PDG
Decay.add('W->qq', 0.6741) # PDG
